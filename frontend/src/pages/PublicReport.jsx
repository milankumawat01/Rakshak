    ...
    <div className="min-h-screen bg-bg-base">
      ...
      <header className="bg-bg-card border-b border-border px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <span className="text-sm text-text-muted">Land Verification Report</span>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className={`rounded-2xl border ${riskStyle.border} ${riskStyle.bg} p-8 text-center`}>
          <div className="text-6xl font-bold mb-2" style={{ color: riskStyle.color }}>
            {report.risk_score ?? "—"}
          </div>
        ...
        {assessment && (
          <div className="bg-bg-card rounded-2xl border border-border p-6">
            <h2 className="text-lg font-semibold text-text-primary mb-4">Risk Breakdown</h2>
        ...
        <div className="text-center text-sm text-text-muted py-4 border-t border-border">
          Generated by BhomiRakshak — AI-Powered Land Verification for Jharkhand
        </div>
      </div>
    </div>
  );
